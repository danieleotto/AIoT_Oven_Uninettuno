...
class MLModel:
    ...
    def get_prev_temp(self, pid_output, temp_forno, temp_rate, res_output, temp_target, step) -> float:
        return self._previsione_temp_futura(temp_forno, temp_rate, res_output, temp_target, step)